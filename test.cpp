...
int generateList(const string &feature_address, const string &depth_address, const string &internalfile,
                 const string &externalfile, const string &namelistfile, const string &depthscalefactor, int feature1,
                 int feature2);
 ...
 */
    ...
    while (getline(matchtxt, s)) {
        ...
        int flag = generateList("/home/yirenli/dev/DatasetGenerationHelper/out/af/keypoints/",
                                "/home/yirenli/dev/DatasetGenerationHelper/out/af/depth_maps/",
                                "/home/yirenli/dev/DatasetGenerationHelper/out/af/cameras_images_txt/cameras.txt",
                                "/home/yirenli/dev/DatasetGenerationHelper/out/af/cameras_images_txt/images.txt",
                                "../out/af/filter_test/namelist.txt",
                                "18.1026",
                                atoi(a[1].c_str()),
                                atoi(a[3].c_str()));
...
int generateList(const string &feature_address, const string &depth_address, const string &internalfile,
                 const string &externalfile, const string &namelistfile, const string &depthscalefactor,
